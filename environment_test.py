...
class StockTradingEnv:
    def __init__(self, initial_amount=5e6, period='I_2019' max_stock=2e2, cost_pct=1e-3, gamma=0.99,
                 beg_idx=0, end_idx=1000):
        self.pd_data = f'./test_{period}.pkl' # './test.pkl' for test
        self.np_data = f'./test_{period}.numpy.npz' # './test.numpy.npz' for test
